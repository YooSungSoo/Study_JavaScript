...
console.log(+sample);
console.log(typeof +sample); // +를 사용하면 number값으로 사용 가능
...
name = name ?? '코드팩토리'; // 좌측값이 NULL이거나 Undefine이면 오른쪽 값으로 초기화
console.log(name);

name = name ?? '아이브'; // name에 값이 있기 때문에 그대로
console.log(name);
